...
function Banner({ netflixOriginals }: Props) {
  ...
  return (
    <div className="flex  flex-col space-y-2 py-16 md:space-y-4 lg:h-[100vh] lg:justify-end lg:pb-12">
      ...
      <h1 className="absolute top-[18%] left-[5%] text-2xl font-bold md:text-4xl lg:text-7xl ">
        {movie?.title || movie?.name || movie?.original_name}
      </h1>
      <p className=" absolute top-[25%]  left-[5%] max-w-xs text-[10px] md:max-w-lg md:text-lg ld:max-w-2xl lg:text-2xl">
        {movie?.overview}
      </p>
      <div className=" absolute top-[50%]  left-[5%] flex space-x-3">
